#ifndef GENERATIONTRACKINGMODIFIER_HPP_
#define GENERATIONTRACKINGMODIFIER_HPP_
...
class GenerationTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    GenerationTrackingModifier(int samplingTimestepMultiple);

    /**
     * Destructor.
     */
    virtual ~GenerationTrackingModifier();
...
#endif /*GENERATIONTRACKINGMODIFIER_HPP_*/
