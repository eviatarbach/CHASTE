#ifndef CONTACTBOUNDARYTRACKINGMODIFIER_HPP
#define	CONTACTBOUNDARYTRACKINGMODIFIER_HPP
...
class ContactBoundaryTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    ContactBoundaryTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~ContactBoundaryTrackingModifier();
...
#endif	/* CONTACTBOUNDARYTRACKINGMODIFIER_HPP */
