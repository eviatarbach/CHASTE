#ifndef ANCESTORTRACKINGMODIFIER_HPP_
#define ANCESTORTRACKINGMODIFIER_HPP_
...
class AncestorTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    AncestorTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~AncestorTrackingModifier();
...
#endif /*ANCESTORTRACKINGMODIFIER_HPP_*/
