#ifndef BOUNDARYTRACKINGMODIFIER_HPP_
#define BOUNDARYTRACKINGMODIFIER_HPP_
...
class BoundaryTrackingModifier : public AbstractCellBasedSimulationModifier<DIM,DIM>
{
...
public:
     ...
     * Default constructor.
     */
    BoundaryTrackingModifier();

    /**
     * Destructor.
     */
    virtual ~BoundaryTrackingModifier();
...
#endif /*BOUNDARYTRACKINGMODIFIER_HPP_*/
